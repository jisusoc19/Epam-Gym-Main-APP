...
public class iTraineServiceImpl implements iTraineeService {
	...
	public List<Trainee> findAll() {
		List<Trainee> lista = (List<Trainee>) traineedaoJpa.findAll();
	...
	public Trainee findById(Long id) {
		if (traineedaoJpa.findById(id) == null || traineedaoJpa.findById(id).isEmpty() ) {
			...
			return traineedaoJpa.findById(id).orElse(null);
		}
	}
	...
	public Trainee findbyusername(String username) {
		...
		if (traineedaoJpa.findByUsername(username).isPresent()) {
	...
	public Trainee updateStatususername(String username, Boolean status) {
		...
		traineeA.getUserid().setIsActive(status);
		traineedaoJpa.save(traineeA);
